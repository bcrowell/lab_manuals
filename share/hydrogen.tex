\lab{The Hydrogen Atom}\label{lab:hydrogen}

\apparatus
\equipn{H gas discharge tube}{1/group}
\equipn{Hg gas discharge tube (PASCO)}{1/group}
...
The first step toward understanding Balmer's numerology was
...
Along with the nice formulas came a whole new set of
...
\mysubsubsection{Sources of systematic errors}
...
\mysubsubsection{Eliminating systematic errors}
...
Here is a list of the wavelengths of the visible Hg lines, in nm, to high precision:
