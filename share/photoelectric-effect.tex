...
we don't need the separate power supply for the discharge tube (Pasco BEM-5007)
...
\figcaption{mo-pho-circuit-new}{The circuit. The light creates an electric current, which
trickles back through the large but finite resistance of the voltmeter.}
...
(%
m4_ifdef([:__lm:],[:\emph{Light and Matter} problem 34-11:],[:\emph{Modern Physics} problem 15-6:])%
),
