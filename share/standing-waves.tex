...
\equip{1 g slotted weights (in tray)}
\equip{pulley}
\equip{vibrator}
\equip{paperclips}
\equip{metersticks}
...
m4_ifdef([:__mod:],[:%
\emph{If you were assigned problem 2-12 in \emph{Modern Physics}, skip the prelab.}   
:],[:%
:])%
...
that it recovers the special cases done numerically in P2.
