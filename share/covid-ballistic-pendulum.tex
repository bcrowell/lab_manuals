...
\labpart{Setup}
    ...
    \begin{enumerate}
        ...
        \includegraphics[width=0.30\textwidth]{figs/BallisticPendulumTarget.pdf}
...
\figcaptionresize{PendulumAssembly_Smaller.png}{Assembly and testing of the ballistic pendulum}
