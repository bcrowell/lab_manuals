...
\equipn{multimeter (in lab bench)}{1/group}
\equip{banana plug cables}
\equip{Leybold 521 545 17-volt DC power supplies (or BK Precision 1505)}
...
% See Kleppner and Kolenkow, p. 426. <KE> is propto omega^2A^2, which is not the same as A^2.
