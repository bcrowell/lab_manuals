...
\equip{converging lens (unknown focal}
\equipn{length to be measured)}{1/group}
\equip{converging lens, longest available}
\equipn{focal length}{1/group}
\equipn{converging lens, $f=50$ mm}{1/group}
...
\labpart{ Focal length of a convex lens}
