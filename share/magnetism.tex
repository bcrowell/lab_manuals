...
\widefigcaption{em-dip-fieldvsdistance}{Part A, measuring the variation of the
bar magnet's field with respect to distance.}\label{fig:dipbofr}

\widefigcaption{em-dip-new-method}{Part B, a different method of measuring
...
As shown in a lecture demonstration, deactivating the electromagnet requires getting
