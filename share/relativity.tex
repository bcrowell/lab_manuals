...
Note: I think we checked in spring 2013 that the PRO-100 meters worked.
...
sheets of SolCopy 20 lb paper were 2307.0 g. About 1/200 of a sheet seemed to
...
of $R$. In spring 2014 I would like to have my students try the following
new technique for measuring $R$ accurately. The idea is to compare the position
of the laser spot on the well when the balance is in its normal position, versus
the position where the wires are touching. Using geometry and trig you can then
find the air gap between the wires, and then add in twice the radius, which can
be measured accurately with vernier calipers.
