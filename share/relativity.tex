...
In spring 2014 had my students try the following
new technique for measuring $R$ accurately. It seemed to work pretty well, so my
goal for spring 2015 is to test is more thoroughly and try to get the best possible data.
...
For spring 2015, I would also like to see how the results compare when you use
the eyeball measurement of $R$. Please present a table showing both values of $R$
and the two corresponding results for $c$. You only need to do error analysis and
interpretation for result based on the laser measurement of $R$.
