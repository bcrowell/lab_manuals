...
When you added the resistor, you should have seen the voltage measured on the scope go
...
Analyze the voltage divider in the final part of the lab purely symbolically, finding
$R_0$ in terms of $R$, $V_R$, and $V_\infty$.
